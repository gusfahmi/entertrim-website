				...
				<section className='wrapper-detail-choose '>
					<div className='row justify-content-center'>
						<div className='col-lg-4 col-md-6'>
							<div className='background-dark list-choose-clients'>
								<div className='wrap-img-client mr-3'>
									<img
								...
								<div className='content-client'>
									...
									<p className='card-text text-clients'>
										...
										<br />
										<i className='fa fa-map-marker'></i> Australia
									</p>
								</div>
							</div>
						</div>
							...
							<div className='background-dark list-choose-clients'>
								...
								<div className='content-client'>
									...
									<p className='card-text text-clients'>
										...
										<br />
										<i className='fa fa-map-marker'></i> Indonesia
									</p>
								</div>
							</div>
						</div>
